...
Correct Bits: ${reportStats.correct}<br/>
Incorrect Bits: ${reportStats.incorrect}<br/>
    ...
    <div class="graph-box">
      ...
      <svg viewBox="0 0 300 300" preserveAspectRatio="none">
       ...
       <!-- Y label -->
        ...
        <!-- QBER point -->
        <circle cx="270" cy="260" r="5" fill="black"/>
        <text x="235" y="245">${reportStats.qber}%</text>
